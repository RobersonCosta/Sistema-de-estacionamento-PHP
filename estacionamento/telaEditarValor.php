<html>
    ...
    <body>
        ...
        <div class="container">
            <form role="form" action="editarValor.php" method="post">
                <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input name="id_valor" type="hidden" value="<?php echo @$_GET['id_valor'];?>">
                    <button type="submit" class="btn btn-default">Alterar valor</button>                    
            </form>
        </div>
    </body>
</html>